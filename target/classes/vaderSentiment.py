...
'''
from sentiment import VaderSentimentType
...
class vaderSentiment(VaderSentimentType):
    ...
    f = '/Users/shawnkyzer/Documents/workspace/sentimentanalyzer/target/classes/vader_sentiment_lexicon.txt' # empirically derived valence ratings for words, emoticons, slang, swear words, acronyms/initialisms
    try:
